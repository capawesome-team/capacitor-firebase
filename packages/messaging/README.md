...
> **Important**: Make sure that no other Capacitor Push Notification plugin is installed (see [here](https://github.com/cap-go/capacitor-firebase/pull/267#issuecomment-1328885820)).
...
See [CHANGELOG.md](https://github.com/cap-go/capacitor-firebase/blob/main/packages/messaging/CHANGELOG.md).

## License

See [LICENSE](https://github.com/cap-go/capacitor-firebase/blob/main/packages/messaging/LICENSE).
