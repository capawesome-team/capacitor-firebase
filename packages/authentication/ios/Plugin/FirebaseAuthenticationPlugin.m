...
CAP_PLUGIN(FirebaseAuthenticationPlugin, "FirebaseAuthentication",
           ...
           CAP_PLUGIN_METHOD(initWithFirebaseConfig, CAPPluginReturnPromise);
           CAP_PLUGIN_METHOD(firebaseAppIsInitialized, CAPPluginReturnPromise);
           CAP_PLUGIN_METHOD(useFirebaseApp, CAPPluginReturnPromise);
           CAP_PLUGIN_METHOD(currentFirebaseApp, CAPPluginReturnPromise);
)
