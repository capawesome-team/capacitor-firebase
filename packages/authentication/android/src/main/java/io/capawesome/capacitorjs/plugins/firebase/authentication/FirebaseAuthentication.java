            ...
            .addOnCompleteListener(
                ...
                task -> {
                    if (task.isSuccessful()) {
                        ...
                        call.reject(FirebaseAuthenticationPlugin.ERROR_LINK_FAILED, task.getException());
                    }
                }
            );
    }
            ...
            .addOnCompleteListener(
                ...
                task -> {
                    if (task.isSuccessful()) {
                        ...
                        call.reject(FirebaseAuthenticationPlugin.ERROR_SIGN_IN_FAILED, task.getException());
                    }
                }
            );
    }
