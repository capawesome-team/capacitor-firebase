...
export declare type AppTrackingTransparencyPermissionState = PermissionState | 'restricted';
/**
 * @since 7.2.0
 */
export declare type RequestAppTrackingTransparencyPermissionResult = CheckAppTrackingTransparencyPermissionResult;
/**
 * @since 0.1.0
 */
 ...
 * @since 6.3.0
 */
export declare type IdTokenChangeListener = (change: GetIdTokenResult) => void;
/**
 * @since 0.1.0
 */
