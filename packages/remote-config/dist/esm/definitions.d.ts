 ...
 * @since 1.3.0
 */
export declare type GetBooleanOptions = GetOptions;
/**
 * @since 1.3.0
 */
export declare type GetNumberOptions = GetOptions;
/**
 * @since 1.3.0
 */
export declare type GetStringOptions = GetOptions;
/**
 * @since 1.3.0
 */
 ...
 * @since 5.4.0
 */
export declare type AddConfigUpdateListenerOptionsCallback = (event: AddConfigUpdateListenerOptionsCallbackEvent | null, error: any) => void;
/**
 * @since 5.4.0
 */
 ...
 * @since 1.3.0
 */
export declare enum GetValueSource {
    /**
